...
--------------------
06e,08apr03,dtr  Adding ifdefs round previous changes to maintain binary
                 compatibility when these mods are not required.
06d,26mar03,max  e500 printf modifiers
