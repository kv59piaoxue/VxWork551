...
--------------------
02o,09jun03,dtr  CP1 merge.
02p,20mar03,wap  Move m2If64BitCounters to funcBind (SPR #86776)
02o,14jan03,rae  Merged from velocecp branch
02n,21nov02,pch  SPR 84107: add _func_altivecTaskRegsGet and _func_altivecProbe
02n,04sep02,dtr  Adding SPE support.
...
FUNCPTR     _func_fastUdpErrorNotify;
FUNCPTR     _func_fastUdpInput;
FUNCPTR     _func_fastUdpPortTest;
FUNCPTR     _func_fclose;
FUNCPTR     _func_fppTaskRegsShow;
#ifdef _WRS_ALTIVEC_SUPPORT
FUNCPTR     _func_altivecProbe;
FUNCPTR     _func_altivecTaskRegsGet;
FUNCPTR     _func_altivecTaskRegsShow;
#endif /* _WRS_ALTIVEC_SUPPORT */
#ifdef _WRS_SPE_SUPPORT
FUNCPTR     _func_speTaskRegsShow;
...
#ifdef ROUTER_STACK
STATUS (*pFFLibIpConfigFlagsChangedFn) (int) = NULL;
#endif /* ROUTER_STACK */

#ifndef VIRTUAL_STACK
BOOL        fastUdpInitialized = FALSE;
#endif

int         m2If64BitCounters = 0;
