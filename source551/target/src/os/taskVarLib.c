...
--------------------
02a,14jan03,pcm  add intLock()/intUnlock() around taskVarAdd() critical code
...
STATUS taskVarAdd
    ...
    /*
     * Link new task variable into list in stack header.  Locking interrupts
     * was chosen over task locking since locking and unlocking interrupts is
     * is much faster than task locking and very little code is in the
     * critical section.
     */
