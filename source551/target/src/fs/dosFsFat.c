...
--------------------
01r,28apr03,jkf  SPR#87911, FIOCONTIG ioctl broken for CONTIG_MAX and sizes
                 greater than nFreeBytes-size requested. Introduced in 72039.
...
LOCAL STATUS fat16ContigAlloc
    ...
    /* firstContig <= (pFatDesc->nFatEnts); ??? for 1st fit ??? */
         curClust < pFatDesc->nFatEnts;	
         curClust++)
        {
        fatEntry = ENTRY_READ (pFd, pFatDesc->dosFatDesc.activeCopyNum,
                               curClust);
