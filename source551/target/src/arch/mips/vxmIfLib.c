...
01h,17sep93,jcf  fixed include path.
01g,07aug93,jcf  added vxmIfBreakQuery.
01f,27jul93,jcf  added vxmIfTtyNum, and vxmIfIntAckSet.
01e,07apr93,maf  now includes "vxmIfLibP2.h" from current directory, for
		   compatibility with RDB build system.
01d,06apr93,del  bullet-proofed interface funcs.
01c,27mar93,del  use vxmIfLib.h for now, added functions. fixed bug
		 in vxmIfInstalled ().
