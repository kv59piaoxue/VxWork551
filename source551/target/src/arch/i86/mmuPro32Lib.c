...
--------------------
01n,19nov02,max  Added DIAB inline assembling
...
#ifdef _DIAB_TOOL
asm void diab_int_lock_32(unsigned int Mask)
{
% reg Mask
	pushf
	popl	Mask
...
asm void diab_int_unlock_32(unsigned int Mask)
{
% reg Mask; lab L
...
#undef INT_LOCK
#define INT_LOCK(oldLevel)	diab_int_lock_32(oldLevel)
#undef INT_UNLOCK
#define INT_UNLOCK(oldLevel)	diab_int_unlock_32(oldLevel)
...
* MMU_STATE_CACHEABLE 	MMU_STATE_CACHEABLE_NOT	 cacheable/not_cacheable
