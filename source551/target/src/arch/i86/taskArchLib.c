...
--------------------
01d,29oct29,hdn  carved X86_EXT from stack for all tasks (spr 70252)
...
LOCAL STATUS taskArchInitDone = FALSE;		/* one time initialization */


/* prototypes */

LOCAL void taskArchInit (void);			 /* arch's init rtn */
LOCAL void taskArchCreateHook (WIND_TCB * pTcb); /* arch's create hook rtn */
...
/*******************************************************************************
*
* taskArchInit - initialize architecture specific hook routines
*
* This routine initializes architecture specific hook routines.
* Currently, it is called from the taskRegsInit() in this file.  
* But there should be better place to call this routine once at 
* initialization time.
* 
* NOMANUAL
*/

LOCAL void taskArchInit (void)
    {
...
/*******************************************************************************
*
* taskArchCreateHook - architecture specific task create hook routine
*
* This routine is the architecture specific task create hook routine.
* 
* NOMANUAL
*/

LOCAL void taskArchCreateHook 
    (
