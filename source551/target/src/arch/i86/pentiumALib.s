/* pentiumALib.s - P5, P6 and P7 family processor specific routines */
...
--------------------
01f,12nov02,hdn  added comment for pentiumCr4Set/Get (spr 83992)
...
* This routine is kept for the backward compatibility, and vxCr4Get() 
* should be used instead.  The CR4 is introduced in the Pentium processor,
* thus this routine just returns in the pre Pentium generation processors.
*
...
FUNC_LABEL(pentiumCr4Get)
	...
	je	pentiumCr4GetExit
	cmpl	$ X86CPU_486,FUNC(sysProcessor)
	je	pentiumCr4GetExit
	cmpl	$ X86CPU_NS486,FUNC(sysProcessor)
	je	pentiumCr4GetExit
...
* This routine is kept for the backward compatibility, and vxCr4Set() 
* should be used instead.  The CR4 is introduced in the Pentium processor,
* thus this routine just returns in the pre Pentium generation processors.
*
* RETURNS: N/A
