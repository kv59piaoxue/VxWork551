...
--------------------
01h,12nov02,hdn  replaced pentiumCr4Set/Get with vxCr4Set/Get (spr 83992)
01g,09sep02,hdn  added regsP7.h for cleaning up 
...
void pentiumMtrrEnable (void)
    ...
    oldCr4 = vxCr4Get ();			/* save CR4 */
    vxCr4Set (oldCr4 & ~CR4_PGE);		/* clear PGE bit */
