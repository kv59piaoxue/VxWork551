/* mmuSh7750Lib.c - Hitachi SH7750 MMU support library */
...
--------------------
01s,20nov01,hk   renamed mmuTLBDump() to mmuUTLBDump(), added mmuITLBDump().
01r,23oct01,hk   allow mmucr customization by setting excMmuCrVal externally.
...
2) Alternate memory source - A customer has special purpose hardware that
   ...
   point to another memory partition before mmuSh7750LibInit is called.
*/
...
IMPORT UINT32 excMmuCrVal;				/* excArchLib.c */
...
UINT32	mmuTransTblSpace = SH7750_P2_BASE;
...
LOCAL MMU_LIB_FUNCS mmuLibFuncsLocal =				/* vmLibP.h */
    {
    mmuSh7750LibInit,		/* FUNCPTR mmuLibInit;        */
...
STATUS mmuSh7750LibInit 
    ...
    mmuCrSet = (FUNCPTR)(((UINT32)mmuCrSetOp
				& SH7750_PHYS_MASK) | SH7750_P1_BASE);
