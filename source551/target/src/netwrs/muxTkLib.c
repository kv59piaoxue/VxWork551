...
--------------------
02m,17jan03,wap  Make muxEndRcvRtn() handle SNARF/PROMISC protocols properly
                 (SPR #85291)
02l,14jan03,rae  Merged from velocecp branch (SPR #83297)
...
LOCAL int muxEndRcvRtn
    ...
    if (muxId->netSvcType != MUX_PROTO_SNARF &&
        muxId->netSvcType != MUX_PROTO_PROMISC)
        {
