...
--------------------
01s,14jan03,rae  Merged from velocecp branch (SPR #79221)
...
M_BLK_ID netMblkChainDup
	...
	if (copyhdr)
	    ...
	    copyhdr = FALSE;
            ...
            /* Don't preserve M_PKTHDR flag if header isn't copied. */
	    pNewMblk->mBlkHdr.mFlags = pMblk->mBlkHdr.mFlags & ~M_PKTHDR; 
