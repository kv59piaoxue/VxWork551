...
--------------------
01t,23jan03,vvv  fixed long file name problem (SPR #85166)
...
IMPORT int nfsMaxFileName;       /* Max. filename length  */
...
readdirres * nfsproc_readdir_2
    ...
    fileNameSize = MEM_ROUND_UP (nfsMaxFileName + 1);
	...
	strncpy (currentName, localEntry->d_name, nfsMaxFileName);
